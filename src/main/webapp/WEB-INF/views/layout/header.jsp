	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			...
			<ul class="navbar-nav">
				<c:choose>
					<c:when test="${empty principal}">
						<li class="nav-item"><a class="nav-link" href="/auth/login_form" style="font-size: 18px">로그인</a></li>
		...
		<div class="float-right">
			<form class="form-inline" action="/board/search" method="get">
				<input type="text" class="form-control m-2" name="q" placeholder="Search" value="${searchTitle}" /> <input type="image" src="/image/search.png" width="50" height="50">
			</form>
		</div>
	</nav>
</body>
